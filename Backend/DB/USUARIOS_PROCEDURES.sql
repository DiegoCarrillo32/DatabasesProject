...
GO
CREATE PROCEDURE INSERT_USUARIO(@CORREO VARCHAR(50), @AREA VARCHAR(30), @NOMBRE VARCHAR(50), @APELLIDO1 VARCHAR(50), @APELLIDO2 VARCHAR(50))
AS
    INSERT INTO USUARIOS(CORREO, AREA) VALUES (
        @CORREO,
        @AREA       
    )
