...
ADD CONSTRAINT DF_ASUNTO DEFAULT 'NOTIFICACIÓN' FOR ASUNTO;*/
GO
--TABLA MENSAJES
...
CREATE TABLE MENSAJES(
	...
	ASUNTO			VARCHAR(75)		NOT NULL DEFAULT 'NOTIFICACIÓN',
...
GO
/*ALTER TABLE CONTROL_ACTIVOS
ADD CONSTRAINT DF_FECHA_CONTROL DEFAULT GETDATE() FOR FECHA_CONTROL;*/
--TABLA DE  CONTROL DE LOS ACTIVOS
CREATE TABLE CONTROL_ACTIVOS(
	ID_ACTIVO		SMALLINT IDENTITY(1,1)		NOT NULL,	
	ESTADO_ACTIVO	VARCHAR(30)		NOT NULL,
	FECHA_CONTROL	DATE			NOT NULL DEFAULT GETDATE(),
