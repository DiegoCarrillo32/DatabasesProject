...
CREATE TABLE MENSAJES(
	...
	ID_MENSAJE		SMALLINT		NOT NULL,
	ASUNTO			VARCHAR(75)		NOT NULL,
	CONTENIDO		VARCHAR(280)	NOT NULL

	CONSTRAINT PK_MENSAJES PRIMARY KEY (ID_MENSAJE),
	CONSTRAINT FK_USUARIOMENSAJES FOREIGN KEY (ID_MENSAJE) REFERENCES USUARIOS(ID_USUARIO)
);
...
CREATE TABLE PRESTAMOS(
	...
	ID_ACTIVO 		SMALLINT		NULL,	--no todos los activos tienen un préstamo
